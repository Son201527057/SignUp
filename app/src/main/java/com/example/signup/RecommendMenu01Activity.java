...
public class RecommendMenu01Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recommend_menu01);
        ...
        ImageView_Banner_03.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenu01Activity.this, Banner03Activity.class);
        ...
        ImageView_Bot_Bar_01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenu01Activity.this, SearchActivity.class);
                startActivity(intent);
            }
        });
        ...
        ImageView_Bot_Bar_02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenu01Activity.this, MainHomeActivity.class);
                startActivity(intent);
            }
        });
        ...
        ImageView_Bot_Bar_03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RecommendMenu01Activity.this, CustomerServiceActivity.class);
                startActivity(intent);
            }
        });
